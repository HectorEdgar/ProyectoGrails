...
<html>
    ...
    <body>
        ...
        <div id="show-archivo" class="content scaffold-show" role="main">
            ...
            <f:display bean="archivo" />
            <g:form resource="${this.archivo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.archivo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
