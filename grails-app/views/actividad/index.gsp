    ...
    <body>
        ...
        <div class="invisible" id="fechas">
            <g:each var="actividad" status="i" in="${actividades}">
                ...
                <input type="text" id="${estadoActividad}" value="${actividad.fechaFinal.getDate()}-${actividad.fechaFinal.getMonth()+1}-${actividad.fechaFinal.getYear()+1900}" hidden="hidden" name="${actividad.nombre}">
            </g:each>
        </div>
      ...
      <div class="row">
        <nav class="col-sm-6 col-md-4 d-none d-sm-block bg-light sidebar">
            ...
            <div id="calendario" class="border border-secondary">
                ...
                <div id="mes" name="mes" class="mes"></div>
                <br><br><br>
        ...
        <main role="main" class="col-sm-12 ml-sm-auto col-md-8 pt-3">
          <section class="row text-center placeholders" id="imprimir">
            <div class="pagination w-100 text-center">
                ...
                <g:link onclick="imprimir('imprimir')" class="text-center">
                    <g:img dir="images" file="imprimir.png" height="20px" class="text-center"/>
                </g:link>
            </div>
            <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ${actividad.fechaFinal.getHours()}:${actividad.fechaFinal.getMinutes()}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <g:if test="${actividad.archivos?.size()==0}">
                                                No hay archivos
                                            </g:if>
                                            <g:each var="${archivo}" in="${actividad.archivos}">
                                                <g:link class="btn btn-outline-dark btn-sm container-fluid" style="max-width:11.5rem" action="descargarArchivo" controller="actividad" params="[ubicacion: archivo.ubicacion]" data-toggle="tooltip" data-placement="top" title="${archivo}">${archivo}
